...
class AlterarDadosImovelActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.editTextTextEndereOAlteradoImovel.setText("${imovel.endereco}",TextView.BufferType.EDITABLE)

        binding.editTextTextTamanhoAlteradoImovel.setText("${imovel.tamanho.toString()}",TextView.BufferType.EDITABLE)
        ...
        binding.buttonAlterarDadosImovel.setOnClickListener(){
            if (binding.editTextTextEndereOAlteradoImovel.text.toString()!=imovel.endereco){
                ...
                //Alterar o Endereço
                imovelDAO.alterarEnderecoImovel(binding.editTextTextEndereOAlteradoImovel.text.toString(), imovel.inscricao)

            }
            if (binding.editTextTextTamanhoAlteradoImovel.text.toString().toInt() != imovel.tamanho) {

                //Alterar o tamanho (e o IPTU)
                imovelDAO.alterarTamanhoImovel(binding.editTextTextTamanhoAlteradoImovel.text.toString().toInt(), imovel.inscricao)
